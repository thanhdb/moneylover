        ...
        <!-- <div class="container" style="width: 50%"> -->
            <form name="editpost" action="" method="POST" role="form">
                ...
                <div class="form-group">
                    ...
                    <input name="title" type="text" class="form-control" id="" value="<?php echo $content['title']; ?>">
                    <label for="">Content</label>
                    <textarea name="content" id="content" class="form-control" rows="3"><?php echo $content['content']; ?></textarea>
                    <label for="">Description</label>
                    <input name="description" type="text" class="form-control" id="" value="<?php echo $content['description']; ?>">
                    <label for="">URL image</label>
                    <input name="images" type="text" class="form-control" id="" value="<?php echo $content['images']; ?>">
                    <label>Time</label>
                    <input type="date" name="write_time" class="form-control" style="max-width: 30%" value="<?php echo $content['write_time']; ?>">
                </div>
